plugins {
    ...
    id("pl.allegro.tech.build.axion-release") version "1.18.13" // https://plugins.gradle.org/plugin/pl.allegro.tech.build.axion-release
...
subprojects {
    ...
    extra.apply {
        ...
        set("junitVersion", "5.11.2")            // https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter-api
