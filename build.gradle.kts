...
subprojects {
    ...
    extra.apply {
        ...
        set("kafkaVersion", "3.5.0")            // https://mvnrepository.com/artifact/org.apache.kafka/kafka-clients
        set("spotBugsVersion", "4.4.2")         // https://mvnrepository.com/artifact/com.github.spotbugs/spotbugs-annotations
        set("guavaVersion", "32.1.0-jre")         // https://mvnrepository.com/artifact/com.google.guava/guava
