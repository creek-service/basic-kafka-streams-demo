plugins {
    ...
    id("pl.allegro.tech.build.axion-release") version "1.17.1" // https://plugins.gradle.org/plugin/pl.allegro.tech.build.axion-release
...
subprojects {
    ...
    extra.apply {
        ...
        set("kafkaVersion", "3.7.0")            // https://mvnrepository.com/artifact/org.apache.kafka/kafka-clients
