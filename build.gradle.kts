plugins {
    ...
    id("pl.allegro.tech.build.axion-release") version "1.18.15" // https://plugins.gradle.org/plugin/pl.allegro.tech.build.axion-release
...
subprojects {
    ...
    extra.apply {
        ...
        set("kafkaVersion", "3.9.0")            // https://mvnrepository.com/artifact/org.apache.kafka/kafka-clients
