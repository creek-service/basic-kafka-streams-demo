...
dependencies {
    implementation("com.github.spotbugs.snom:spotbugs-gradle-plugin:6.2.3")                // https://plugins.gradle.org/plugin/com.github.spotbugs
    ...
    implementation("org.creekservice:creek-system-test-gradle-plugin:0.4.3")                // https://plugins.gradle.org/plugin/org.creekservice.system.test
}