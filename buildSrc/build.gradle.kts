...
dependencies {
    implementation("com.github.spotbugs.snom:spotbugs-gradle-plugin:6.5.8")                // https://plugins.gradle.org/plugin/com.github.spotbugs
    implementation("com.diffplug.spotless:spotless-plugin-gradle:8.8.0")                   // https://plugins.gradle.org/plugin/com.diffplug.spotless
