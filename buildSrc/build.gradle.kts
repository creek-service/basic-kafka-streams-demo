...
dependencies {
    implementation("com.github.spotbugs.snom:spotbugs-gradle-plugin:5.2.4")                // https://plugins.gradle.org/plugin/com.github.spotbugs
    implementation("com.diffplug.spotless:spotless-plugin-gradle:6.23.0")                   // https://plugins.gradle.org/plugin/com.diffplug.spotless
