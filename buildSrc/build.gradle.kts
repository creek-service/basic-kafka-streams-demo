...
dependencies {
    implementation("com.github.spotbugs.snom:spotbugs-gradle-plugin:5.1.2")                // https://plugins.gradle.org/plugin/com.github.spotbugs
    implementation("com.diffplug.spotless:spotless-plugin-gradle:6.20.0")                   // https://plugins.gradle.org/plugin/com.diffplug.spotless
